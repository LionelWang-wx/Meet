            ...
            public void done(IMUser imUser, BmobException e) {
                if (e == null) {
                    ...
                    if (e.getErrorCode() == 207) {
                        showToast(LoginActivity.this, getString(R.string.text_login_code_error));
                    } else {
        ...
        BmobManager.getInstance().requestSMS(phoneNumber, new QueryListener<Integer>() {
            ...
            public void done(Integer integer, BmobException e) {
                if (e == null) {
                    ...
                    showToast(LoginActivity.this, getString(R.string.text_user_resuest_succeed));
                } else {
                    btn_send_code.setEnabled(true);
                    btn_send_code.setText("发送");
                    showToast(LoginActivity.this, getString(R.string.text_user_resuest_fail));
                }
            }
        });
